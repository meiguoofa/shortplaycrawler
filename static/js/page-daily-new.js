                            ...
                            <div class="space-y-4">
                                <div class="flex flex-wrap gap-4">
                                    <div class="min-w-[200px]">
                                        ...
                                        <n-select v-model:value="targetLang">
                                            <n-option v-for="(name, code) in config.langs" :key="code"
                                                       :value="code" :label="name + ' (' + code + ')'" />
                                        </n-select>
                                    </div>
                                    <div class="min-w-[280px] flex-1 max-w-md">
                                        <div class="text-sm text-gray-500 dark:text-gray-400 mb-1">生图模型</div>
                                        <n-select v-model:value="imageModel">
                                            <n-option v-for="m in config.imageModels" :key="m" :value="m" :label="m" />
                                        </n-select>
                                    </div>
